...
var ErrTimeout = errors.New("Time out Fetching data to long")

var ErrClaimJWTFailed = errors.New("Failed to get validated claims")

var ErrClaimCustomJWTFailed = errors.New("Failed to cast custom JWT claims to specific type.")

var ErrFailedSecurityCheck = errors.New("Request is not valid.")

var ErrFailedDownload = errors.New("There are error in download file processing")

var ErrClaimSTSCredential = errors.New("Failed to get sts credential from context claims")
